...
using Abp.Threading;
using CourseDotNet.Class2.Configuration;
using CourseDotNet.Class2.Configuration.Ui;
using CourseDotNet.Class2.Sessions;
using CourseDotNet.Class2.Web.Models;
using CourseDotNet.Class2.Web.Models.Layout;

namespace CourseDotNet.Class2.Web.Controllers
{
    public class LayoutController : Class2ControllerBase
    {
