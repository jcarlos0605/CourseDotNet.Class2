...
using CourseDotNet.Class2.Authorization;
...
using CourseDotNet.Class2.Sessions;
using CourseDotNet.Class2.Web.Controllers.Results;
using CourseDotNet.Class2.Web.Models;
using CourseDotNet.Class2.Web.Models.Account;
...
{
    public class AccountController : Class2ControllerBase
    {
